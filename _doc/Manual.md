...
```yml
# Site settings
title: Chen's Blog             # title of your website
SEOTitle: Chen's Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: chsixue     # modify this account to yours
weibo_username: chsixue      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-chen.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“Chen's Blog”** but I want the title shows in search engine is **“黄玄的博客 | Chen's Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/chsixue/chsixue.github.io/issues/15) about code wrap.
